...
try:
    ...
    import pydrake.solvers.clp as CLP_drake
    # use Gurobi solver
    ...
    clp_solver = CLP_drake.ClpSolver()
except:
...
def distance_point_polytope(P, x, ball="infinity", solver="__"):
    """
...
def AH_polytope_vertices(P,N=200,epsilon=0.001,solver="osqp"):
    """
